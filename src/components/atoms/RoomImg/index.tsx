...
const RoomImg: React.FC<IRoomImgProps> = ({ src, onRemove }) => {
  return (
    ...
    >
      <div
        className={
          "absolute z-0 w-full h-full sm:w-200 mr-2 even:mr-0 sm:even:mr-2 border border-gray-300  bg-no-repeat bg-contain bg-center"
        }
      ...
      >
        ...
        >
          <Button className={" bg-white z-10"} onClick={onRemove}>
